...
create_project U500VU190DevKit $wrkdir -part $part_fpga -in_memory
...
set tbdir [file join $srcdir tb]
set tbverilogfiles [recglob $tbdir "*.v"]
add_files -norecurse -fileset $obj $srcmainverilogfiles
remove_files $tbverilogfiles
add_files -norecurse -fileset sim_1 $tbverilogfiles
